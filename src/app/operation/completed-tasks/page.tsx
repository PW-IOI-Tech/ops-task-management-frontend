...
import { ArrowLeft, Search, Filter, Eye, Edit, Calendar, CheckCircle2, AlertCircle, RotateCcw } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { Task, TaskFilter } from '../utils/task'; // Adjust the import path as necessary
import ParameterInputModal from '../utils/ParameterInputModel';
...
const sampleCompletedTasks: Task[] = [
  {
    ...
    description: "Conducted monthly team sync meeting",
    category: "Management",
    subCategory: "Meetings",
    parameter: "2025-08-15",
    parameterType: "date",
    remark: "Good participation from all team members",
    due: "15-08-2025",
    taskType: "normal",
    completedDate: "15-08-2025" // ✅ Completed on due date
  },
  {
    id: 102,
    name: "Security patch deployment",
    description: "Applied security updates to production servers",
    parameter: "PATCH-SEC-001",
    parameterType: "text",
    remark: "Deployed successfully with no downtime",
    due: "18-08-2025",
    taskType: "ad-hoc",
    completedDate: "17-08-2025" // ✅ Completed early
  },
  {
    id: 103,
    name: "Code review",
    description: "Reviewed pull requests for feature updates",
    category: "Development",
    subCategory: "Quality Assurance",
    parameter: "15",
    parameterType: "number",
    remark: "Reviewed 15 pull requests - all approved",
    due: "19-08-2025",
    taskType: "normal",
    completedDate: "19-08-2025" // ✅ Completed on due date
  },
  {
    id: 104,
    name: "Inventory audit",
    description: "Completed monthly inventory audit",
    category: "Operations",
    subCategory: "Audit",
    parameter: "09:30",
    parameterType: "time",
    remark: "Audit completed at 9:30 AM - no discrepancies found",
    due: "20-08-2025",
    taskType: "normal",
    completedDate: "20-08-2025" // ✅ Completed on due date
  },
  {
    id: 105,
    name: "Equipment calibration",
    description: "Calibrated measuring equipment in lab",
    category: "Laboratory",
    subCategory: "Maintenance",
    parameter: "±0.01mm",
    parameterType: "readings",
    remark: "All equipment within tolerance of ±0.01mm",
    due: "17-08-2025",
    taskType: "normal",
    completedDate: "16-08-2025" // ✅ Completed early
  },
  {
    id: 106,
    name: "Emergency power outage response",
    description: "Handled emergency power outage in building",
    parameter: "PWR-OUTAGE-001",
    parameterType: "text",
    remark: "Backup generators activated successfully",
    due: "16-08-2025",
    taskType: "ad-hoc",
    completedDate: "16-08-2025" // ✅ Completed on same day (emergency)
  },
 
];

interface CompletedTasksProps {
  completedTasks?: Task[]; // Make it optional with default
  onUpdateTask: (taskId: number, updatedFields: Partial<Task>) => void;
  onMarkIncomplete: (taskId: number) => void;
}

const CompletedTasks: React.FC<CompletedTasksProps> = ({
  completedTasks = sampleCompletedTasks, // Provide default empty array
  onUpdateTask,
  onMarkIncomplete
}) => {
      ...
      <div className="p-6">
                    ...
                    <tr key={task.id} className="border-b border-gray-100 hover:bg-green-50 transition-colors duration-150">
                      ...
                      <td className="py-4 px-6">
                        ...
                        >
                          ...
                          <span className="text-gray-800">{task.parameter || 'View Parameter'}</span>
                        </button>
                      </td>
                      <td className="py-4 px-6">
                        <button
                          onClick={() => handleRemarkClick(task)}
                          className="flex items-center justify-center w-8 h-8 bg-green-100 hover:bg-green-200 text-green-600 rounded-lg transition-colors duration-150 hover:shadow-sm"
                      ...
                      <td className="py-4 px-6">
                        <button
                          ...
                          className="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg text-sm font-medium hover:bg-orange-700 transition-colors duration-150 hover:shadow-md"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-6 gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50">
              Previous
            </button>
